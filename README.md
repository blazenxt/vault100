...
# The quorum press — Shamir M-of-N: 5 slips, any 3 reprint the secret
python -m vault100 share split combo.txt -n 5 -m 3
...
* **2.0.26** — **the writ desk (legal completeness)**: privacy page becomes a full **privacy policy** (controller & DPDP grievance, itemised personal data, processors & pipe-carriers with self-host exit, retention, rights-by-architecture, breach, children, measured-claims clause) · terms gain §9–15 (acceptable use, no-recovery & backups, export/sanctions, marks, liability ceiling, abuse & lawful process, governing law & forum) · **about: provenance shelf** (third-party notices + proprietor & seat) · **features: Schedule B — the threat model, plainly stated** (what the ledger cannot resist, said before asked) · `web/vendor/NOTICES.txt` full license texts in every parcel (app included) · titles/plain names for policies
